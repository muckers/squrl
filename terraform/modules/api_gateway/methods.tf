...
# ============================================================================
# OPTIONS /create - CORS preflight for create endpoint
# ============================================================================
...
# HEAD /{short_code} - Head method for redirect endpoint (for cached_methods support)
...
resource "aws_api_gateway_method_response" "redirect_head_301" {
  rest_api_id = aws_api_gateway_rest_api.squrl_api.id
  resource_id = aws_api_gateway_resource.short_code.id
...
resource "aws_api_gateway_method_response" "redirect_head_404" {
  rest_api_id = aws_api_gateway_rest_api.squrl_api.id
  resource_id = aws_api_gateway_resource.short_code.id
  http_method = aws_api_gateway_method.redirect_head.http_method
  status_code = "404"
...
resource "aws_api_gateway_method_response" "redirect_head_500" {
  rest_api_id = aws_api_gateway_rest_api.squrl_api.id
  resource_id = aws_api_gateway_resource.short_code.id
  http_method = aws_api_gateway_method.redirect_head.http_method
  status_code = "500"
...
resource "aws_lambda_permission" "redirect_head" {
  statement_id  = "AllowExecutionFromAPIGateway-HEAD"
  action        = "lambda:InvokeFunction"
  function_name = var.redirect_lambda_arn
  principal     = "apigateway.amazonaws.com"
